...
public class NTLMTokenBuilder implements AssertionBuilder<Element> {

    public static final QName NTLM_AUTHENTICATION = 
        new QName("http://schemas.microsoft.com/ws/06/2004/policy/http", "NtlmAuthentication"); 
    @Override
    public Assertion build(Element element, AssertionBuilderFactory factory) throws IllegalArgumentException {
        final SPConstants.SPVersion spVersion = SPConstants.SPVersion.SP11;
        ...
        return new NTLMToken(spVersion,
    ...
    public QName[] getKnownElements() {
        return new QName[]{NTLM_AUTHENTICATION};
    }
