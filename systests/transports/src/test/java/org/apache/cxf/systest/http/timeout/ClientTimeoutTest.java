...
public class ClientTimeoutTest extends AbstractBusClientServerTestBase {
    ...
    public void clientTimeoutWithParallelCalls() throws Exception {
        ...
        assertThat(f1.getCause().getMessage(), matchesPattern(".*2.000 milliseconds timeout.*"));
        ...
        assertThat(f2.getCause().getCause().getMessage(), matchesPattern(".*4.000 milliseconds timeout.*"));
    }
